  ...
  <SafeAreaView style={styles.defaultScreen}>
    <NatContainer>
      <ScrollView>
        ...
        <NatText
          value="subtitle1. Lorem ipsum dolor sit amet, consectetur adipscing elit. Quos blanditiis tenetur"
          type="subtitle1"
        />
        <NatText
          value="subtitle2. Lorem ipsum dolor sit amet, consectetur adipscing elit. Quos blanditiis tenetur"
          type="subtitle2"
        />
        <NatText
        ...
        />
        <NatText
          value="body2. Lorem ipsum dolor sit amet, consectetur adipscing elit. Quos blanditiis tenetur unde suscipit, quam beatae rerum inventore consectetur, neque doloribus, cupiditate numquam dignissimos"
          type="body2"
        />
        ...
        <NatText
          value="body1. Set diffente color"
          type="body1"
          color={ThemeNaturaLight.palette.primary.main}
        />
        <NatText
          value="body1. Withou marginBottom spacingNone"
          type="body1"
          margin={ThemeNaturaLight.spacing.spacingNone}
        />
        <NatText
          value="body1. Withou marginBottom spacingHuge"
          type="body1"
          margin={ThemeNaturaLight.spacing.spacingHuge}
        />
        <NatText
          value="body1. Withou marginBottom spacingMicro"
          type="body1"
          margin={ThemeNaturaLight.spacing.spacingMicro}
        />
      </ScrollView>
    </NatContainer>
  </SafeAreaView>
