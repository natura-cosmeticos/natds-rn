...
const styleType = ({ color, size, theme, type }) => {
  const colorsType = {
    default: {
...
export const FABWrapper = styled.TouchableOpacity`
  background-color: ${({ color, size, theme, type }) =>
    styleType({
      color,
      size,
      theme,
  ...
  border-radius: ${({ color, size, theme, type }) =>
    styleType({
      color,
      size,
      theme,
...
export const FABText = styled.Text`
  ...
  font-size: ${({ color, size, theme, type }) =>
    styleType({
      color,
      size,
      theme,
  ...
  line-height: ${({ color, size, theme, type }) => {
