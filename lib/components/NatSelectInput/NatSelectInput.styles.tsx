...
export const InputWrapper = styled.View`
  border: ${({ type, state, theme }) =>
    getInputStyles(type, state, theme).border || "1px"};
  border-color: ${({ type, state, theme }) =>
    getInputStyles(type, state, theme).borderColor};
  border-radius: 4px;
  ...
  background-color: ${({ type, state, theme }) =>
    getInputStyles(type, state, theme).backgroundColor || "transparent"};
`;
export const TextInput = styled.TextInput`
  ...
  padding-bottom: ${({ numberOfLines }) =>
    numberOfLines > 1 ? "16px" : "0px"};
  text-align-vertical: top;
  height: ${({ defaultSize }) => defaultSize || "56px"};
  color: ${({ type, state, theme }) =>
    getInputStyles(type, state, theme).fontColor ||
...
export const Label: React.SFC<LabelProps> = ({ type, state, theme, text }) => {
...
export const InputIcon = styled.Image`
  height: 24;
  width: 24;
  tint-color: ${({ type, state, theme }) =>
    getInputStyles(type, state, theme).color};
`;
