...
describe('Container component', () => {
  ...
  it('Should render container component with custom styling', () => {
    ...
    expect(container).toHaveStyleRule('padding-top', 16);
    expect(container).toHaveStyleRule('padding-right', 16);
    expect(container).toHaveStyleRule('padding-bottom', 24);
    expect(container).toHaveStyleRule('padding-left', 16);
  });
